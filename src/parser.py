...
def parse_args():
    ...
    parser.add_argument("--NC_ratio", type=float, default=0.4, help="Value for identify NC samples")
    ...
    parser.add_argument("--logs", type=str, default="/mnt/nfs1/hanhc/NCU/logs", help="Logs directory path")
    parser.add_argument("--model_name", type = str, default = "CLIP_VITB16", choices = ["CLIP_VITB16", "CLIP_VITB32"], help = "Model Name")
    parser.add_argument("--train_data", type = str, default = None, help = "Path to train data csv/tsv file")
    parser.add_argument("--eval_data_type", type = str, default = None, choices = ["Caltech101", "CIFAR10", "CIFAR100", "DTD", "FGVCAircraft", "Flowers102", "Food101", "GTSRB", "SUN397", "ImageNet1K", "OxfordIIITPet", "RenderedSST2", "StanfordCars", "STL10", "SVHN", "EuroSAT", "RESISC45", "ImageNetSketch", "ImageNetV2", "ImageNet-A", "ImageNet-R"], help = "Test dataset type")
    ...
    parser.add_argument("--linear_probe_num_epochs", type = int, default = 64, help = "Linear Probe num epochs")
    ...
    parser.add_argument("--epochs", type = int, default = 8, help = "Number of total train epochs")
    parser.add_argument("--epochs_HN", type=int, default=2, help="Number of HN train epochs")
    parser.add_argument("--batch_size_prompt", type = int, default = 128, help = "Batch size")
    parser.add_argument("--batch_size", type=int, default=128, help="Batch size")
    parser.add_argument("--lr_UL", type = float, default = 5e-4, help = "Learning rate for unlearning")
    parser.add_argument("--lr_pre", type=float, default=5e-4, help="Learning rate")
    parser.add_argument("--lr_HN", type=float, default=5e-4, help="Learning rate for hardest negatives")
    ...
    parser.add_argument("--gamma", type=float, default=0.7, help="Balance factor")
    parser.add_argument("--weight_decay", type = float, default = 0.1, help = "Adam weight decay")
    parser.add_argument("--weight_decay_prompt", type=float, default=1e-2, help="Adam weight decay for prompt")
