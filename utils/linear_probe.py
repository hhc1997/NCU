...
def get_dataloader(options, train):
    ...
    dataloader = torch.utils.data.DataLoader(dataset, batch_size = options.batch_size, shuffle = train, worker_init_fn = options.worker_init_fn, prefetch_factor = 4, generator = options.generator)
